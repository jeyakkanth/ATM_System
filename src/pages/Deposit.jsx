...
import { ArrowLeft, ArrowDownCircle, DollarSign, AlertCircle, CheckCircle2 } from 'lucide-react';
...
const Deposit = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await transactionService.deposit(account.id, val);
            const updatedAccount = await transactionService.getBalance(user.id);
            updateAccount(updatedAccount);
            setStatus({ type: 'success', message: `Deposit successful! Your balance has been updated.` });
            setAmount('');
        ...
        <div className="container animate-fade-in">
            ...
            <div className="max-w-xl mx-auto">
                <div className="glass p-8 relative overflow-hidden">
                    ...
                    <p className="text-text-secondary mb-8">Enter the amount you want to deposit into your account.</p>

                    <div className="bg-white/5 p-6 rounded-2xl mb-8 flex flex-col items-center border border-white/5">
                        <span className="text-text-secondary text-sm mb-1">Current Balance</span>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="input-group">
                            <label className="text-white font-medium mb-2 block">Enter Deposit Amount 💰</label>
                            <p className="text-text-secondary text-xs mb-3">Add funds to your account quickly and securely.</p>
                        ...
                        <div className="flex gap-4">
                            ...
                            >
                                {loading ? 'Processing your transaction...' : 'Confirm Deposit'}
                            </button>
                        </div>
                    </form>
                </div>
